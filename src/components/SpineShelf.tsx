...
const SpineShelf: FC<SpineShelfProps> = ({ books, onSelect }) => {
  return (
    <div className="overflow-x-auto border-t-2 border-black pt-4">
      <div className="flex items-end gap-3 pb-2">
        {books.map((book) => {
          ...
          const showGutterLine = book.spine !== 'thin';
          ...
          return (
            <button
              ...
              className={`group relative flex ${heightClass} ${widthClass} flex-none items-center justify-center border-2 border-black bg-white text-black shadow-none outline-none hover:bg-black hover:text-white focus-visible:ring-2 focus-visible:ring-black`}
            >
              {showGutterLine ? (
                <span
              ...
              <span
                className="text-center font-mono text-[0.65rem] font-semibold uppercase tracking-wide"
